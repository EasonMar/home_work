        ...
        value: function clickAction() {
            ...
            this.element.click(function () {
                ...
                if (_this.element.hasClass('stop')) {
                    _this.element.css({ 'background': 'url(../img/thumb.jpg) no-repeat', 'backgroundSize': 'contain', 'width': '300px' });
                ...
                if (_this.num < 10) {
                    ...
                    _this.element.css({ 'background': 'url(../img/thumb10.jpg) no-repeat', 'backgroundSize': 'contain', 'width': '428px' });
